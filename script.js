        ...
        class Fournisseur {
            ...
            initDB() {
                ...
                request.onupgradeneeded = (event) => {
                    ...
                    store.put({ id: 1, nom: 'Bougelez', montant_restant: 0.00 });
                };
            ...
            verserMontant(montantVerse) {
                ...
                getRequest.onsuccess = (event) => {
                    ...
                    if (fournisseur) {
                        // Vérifier si le versement est possible
                        if (fournisseur.montant_restant - montantVerse < 0) {
                            alert("Erreur : le montant à verser dépasse le montant restant.");
